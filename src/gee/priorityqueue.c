/* priorityqueue.c generated by valac 0.19.0.4-d6d4, the Vala compiler
...
static void _gee_priority_queue_updated_degree (GeePriorityQueue* self, GeePriorityQueueType1Node* node, gboolean child_removed) {
	...
	if (_tmp65_ != NULL) {
		...
		GeePriorityQueueType1Node* _tmp79_;
		GeePriorityQueueType1Node* _tmp80_;
		...
		_tmp68_ = _gee_priority_queue_node_pair_ref0 (_tmp67_);
		pair = _tmp68_;
		_tmp70_ = pair;
		_tmp71_ = _tmp70_->node1;
		_tmp72_ = node;
		if (_tmp71_ == _tmp72_) {
			GeePriorityQueueNodePair* _tmp73_;
			GeePriorityQueueType1Node* _tmp74_;
			_tmp73_ = pair;
			_tmp74_ = _tmp73_->node2;
			_tmp69_ = _tmp74_;
		} else {
			GeePriorityQueueNodePair* _tmp75_;
			GeePriorityQueueType1Node* _tmp76_;
			_tmp75_ = pair;
			_tmp76_ = _tmp75_->node1;
			_tmp69_ = _tmp76_;
		}
		_tmp77_ = _tmp69_;
		_tmp78_ = _gee_priority_queue_node_ref0 (_tmp77_);
		other = _tmp78_;
		_tmp79_ = node;
		_tmp79_->pair = NULL;
		_tmp80_ = other;
		...
		if (_tmp82_ != NULL) {
			...
			_tmp83_ = pair;
			_tmp84_ = _tmp83_->lp_prev;
			_tmp85_ = pair;
			_tmp86_ = _tmp85_->lp_next;
			_tmp87_ = _gee_priority_queue_node_pair_ref0 (_tmp86_);
			_gee_priority_queue_node_pair_unref0 (_tmp84_->lp_next);
			_tmp84_->lp_next = _tmp87_;
		} else {
			...
			_tmp90_ = _gee_priority_queue_node_pair_ref0 (_tmp89_);
			_gee_priority_queue_node_pair_unref0 (self->priv->_lp_head);
			self->priv->_lp_head = _tmp90_;
		}
		_tmp91_ = pair;
		_tmp92_ = _tmp91_->lp_next;
		if (_tmp92_ != NULL) {
			GeePriorityQueueNodePair* _tmp93_;
			GeePriorityQueueNodePair* _tmp94_;
			GeePriorityQueueNodePair* _tmp95_;
			GeePriorityQueueNodePair* _tmp96_;
			_tmp93_ = pair;
			_tmp94_ = _tmp93_->lp_next;
			_tmp95_ = pair;
			_tmp96_ = _tmp95_->lp_prev;
			_tmp94_->lp_prev = _tmp96_;
		} else {
			GeePriorityQueueNodePair* _tmp97_;
			GeePriorityQueueNodePair* _tmp98_;
			GeePriorityQueueNodePair* _tmp99_;
			_tmp97_ = pair;
			_tmp98_ = _tmp97_->lp_prev;
			_tmp99_ = _gee_priority_queue_node_pair_ref0 (_tmp98_);
			_gee_priority_queue_node_pair_unref0 (self->priv->_lp_tail);
			self->priv->_lp_tail = _tmp99_;
		}
