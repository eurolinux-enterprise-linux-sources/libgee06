/* mergesort.c generated by valac 0.19.0.4-d6d4, the Vala compiler
...
void gee_merge_sort_sort (GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeList* list, GCompareFunc compare) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp0_, GEE_TYPE_ARRAY_LIST)) {
		...
		_tmp1_ = list;
		_tmp2_ = compare;
		gee_merge_sort_sort_arraylist (g_type, (GBoxedCopyFunc) g_dup_func, g_destroy_func, G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, GEE_TYPE_ARRAY_LIST, GeeArrayList), _tmp2_);
	} else {
		GeeList* _tmp3_;
		GCompareFunc _tmp4_;
		_tmp3_ = list;
